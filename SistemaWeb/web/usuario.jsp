<%-- 
   Tela de alteração do usuário podendo mudar a senha,nível, é o nome completo.
--%>
...
<form id="formUsuario" method="get" action="Usuario">
    <c:choose>
        <c:when test="${param.acao eq 'novo'}">
                ...
                <div class="campos">
                    <label for="Nivel">Nivel Usuário:</label>
                    <input type="number" min="1" max="3" name="nivel"  required="true" size="1" maxlength="1"/> <br>  <br>1-Usuário<br>2-Funcionário<br> 3-Administrador
                </div><br>
                <div class="campos">
